...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-01-2023 a las 14:54:50
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `color_id` (`color_id`,`type_id`,`company_id`),
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`color_id`) REFERENCES `color_id` (`id`),
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`type_id`) REFERENCES `type_id` (`id`),
  ADD CONSTRAINT `products_ibfk_3` FOREIGN KEY (`company_id`) REFERENCES `company_id` (`id`);
COMMIT;
